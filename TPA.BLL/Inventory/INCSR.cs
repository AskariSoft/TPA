...
namespace TPA.BLL.IN
{
    public class INCSR
    {
        ...
        public int Auth_GST(int vComp_ID, int vUser_ID, string vAuth_D)
        {
            int strRetValue = 0;
            ...
            SCmd.Parameters.Add(new SqlParameter("@nU_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vUser_ID));
            ...
            clsDatabase1.Get_DS_SP("stpInv_Tr_CSR", SCmd);
            strErrorCode = clsDatabase1.sErrorCode.Trim();
            strRetValue = Convert.ToInt32(SCmd.Parameters["@nReturn"].Value);
            return strRetValue;
        }
        public int Auth_Print(int vInv_SqNo,int vComp_ID, int vUser_ID, string vAuth_D)
        {
            int strRetValue = 0;
            SqlCommand SCmd = new SqlCommand();
        ...
        public DataSet Get_Balances(int vComp_ID, int vItem_ID, DateTime vTr_Date, DateTime vFYSDate, DateTime vFYEDate,int vDept_ID)
        {
            ...
            ds_1 = clsDatabase1.Get_DS_SP("stpInv_Tr_CSR", SCmd);
            strErrorCode = clsDatabase1.sErrorCode.Trim();
            vS_Rate = Convert.ToDouble(SCmd.Parameters["@nInv_Bal_Rate"].Value);
            return ds_1;
        }
        public DataSet Get_Balance(int vComp_ID, int vUser_ID, int vBranch_ID, int vDetail_ID, int vSub_ID, DateTime vFYSDate, DateTime vTr_Date)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();
            ...
            SCmd.Parameters.Add(new SqlParameter("@nU_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vUser_ID));
            SCmd.Parameters.Add(new SqlParameter("@dTr_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vTr_Date.Date));
            SCmd.Parameters.Add(new SqlParameter("@dFYSdate", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vFYSDate.Date));
            ...
            SCmd.Parameters.Add(new SqlParameter("@nParty_Detail_ID", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vDetail_ID));
            SCmd.Parameters.Add(new SqlParameter("@nParty_Sub_ID", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vSub_ID));
        ...
        public DataSet Fill_Items(int vComp_ID,int vUser_ID, int vCatSub_ID)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();

            SCmd.Parameters.Add(new SqlParameter("@nComp_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vComp_ID));
            SCmd.Parameters.Add(new SqlParameter("@nCatSub_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vCatSub_ID));
            SCmd.Parameters.Add(new SqlParameter("@nU_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vUser_ID));
        ...
        public DataSet Fill_CatSub(int vComp_ID,int vU_S)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();
        ...
        public DataSet Find_Sale(int vComp_ID, string vDoc_Tr_No)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();

            SCmd.Parameters.Add(new SqlParameter("@nComp_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vComp_ID));
            SCmd.Parameters.Add(new SqlParameter("@sDoc_Tr_No", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vDoc_Tr_No));
        ...
        public DataSet Find_RecordBy_ItemD(string vItem_D, string vU_Name, int vUser_ID, int vComp_ID)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();
            ...
            SCmd.Parameters.Add(new SqlParameter("@nU_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vUser_ID));
            SCmd.Parameters.Add(new SqlParameter("@nIsUpdate", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, 11));
            ds_1 = clsDatabase1.Get_DS_SP("stpInv_Tr_CSR", SCmd);
            strErrorCode = clsDatabase1.sErrorCode.Trim();
            return ds_1;
        ...
        public DataSet Fill_cfgS(int vComp_ID, int vUser_ID, int vBranch_ID, string vSearch, string vDetail_Code, string vSub_D)
        {
            DataSet ds_1; 
            SqlCommand SCmd = new SqlCommand();
        ...
        public int Save_Authorize(int vInv_SqNo, string vTr_No, DateTime vTr_Date, DateTime vFYSDate, int vBranch_ID, int vDept_ID,
           int vDept_ID_Store, double vQty_Item, string vRef1, string vRef2, int vTrLevel,
            int vComp_ID, string vU_Name, int vU_S, string vAuth_D,int vFY_ID)
        {
            ...
            //SCmd.Parameters.Add(new SqlParameter("@nVrType", SqlDbType.Int, 4, ParameterDirection.Input, true, 18, 0, string.Empty, DataRowVersion.Proposed, 91));
            ...
            SCmd.Parameters.Add(new SqlParameter("@nQty_Item", SqlDbType.Money, 9, ParameterDirection.Input, false, 18, 2, "", DataRowVersion.Proposed, vQty_Item));
            ...
            database1 clsdatabase1 = new database1();
            clsdatabase1.Exec_Int_SP_S("stpInv_Tr_CSR", SCmd);
            strErrorCode = clsdatabase1.sErrorCode.Trim();
        ...
        public int Save_Rollback(int vInv_SqNo, int vTrLevel, int vComp_ID, int vBranch_ID, string vU_Name, 
            int vU_S, string vAuth_D,int vFY_ID)
        {
            SqlCommand SCmd = new SqlCommand();
            int nRet_Val = 0;
            strErrorCode = "";
            ...
            database1 clsdatabase1 = new database1();
            clsdatabase1.Exec_Int_SP("stpInv_Tr_CSR", SCmd);
            strErrorCode = clsdatabase1.sErrorCode.Trim();
            nRet_Val = Convert.ToInt32(SCmd.Parameters["@nRetValue"].Value);
            try
            {
        ...
        public int Save_Master(string vInv_SqNo,string vDoc_Inv_SqNo, string vTr_No, DateTime vTr_Date, int vComp_ID, int vDetail_ID, int vSub_ID, int vDept_ID, int vDept_ID_Store, int vBranch_ID, string vParty_Address1, string vParty_Address2,
            string vParty_City, string vParty_Person, string vParty_Cell, int vDType_ID, string vCurr_ID, double vCurr_Rate, int vCCType_ID, int vTrType_ID,
            string vRef1, string vRef2,
            double vQty_Item, double vQty_FOC, double vAmt_Item, double vAmt_Dis, double vAmt_Total, double vAmt_Bal, double vAmt_Cash, double vAmt_CC, double vAmt_R1, List<DataRow> vlstDetail,
            int vTrLevel, string vU_Name, int vU_S, int vIsUpdate, string vAuth_D, int vFY_ID
             )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    SCmd.Parameters.Add(new SqlParameter("@nDoc_Inv_SqNo", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vDoc_Inv_SqNo));
                SCmd.Parameters.Add(new SqlParameter("@sTr_No", SqlDbType.VarChar, 20, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Proposed, vTr_No));
                ...
                //SCmd.Parameters.Add(new SqlParameter("@nVrType", SqlDbType.Int, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, 27));
                SCmd.Parameters.Add(new SqlParameter("@dTr_Date", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vTr_Date.Date));
                SCmd.Parameters.Add(new SqlParameter("@nComp_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vComp_ID));
                SCmd.Parameters.Add(new SqlParameter("@nParty_Detail_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vDetail_ID));
                SCmd.Parameters.Add(new SqlParameter("@nParty_Sub_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vSub_ID));
                SCmd.Parameters.Add(new SqlParameter("@sParty_Address1", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Address1));
                SCmd.Parameters.Add(new SqlParameter("@sParty_Address2", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Address2));
                SCmd.Parameters.Add(new SqlParameter("@sParty_City", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_City));
                SCmd.Parameters.Add(new SqlParameter("@sParty_Person", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Person));
                SCmd.Parameters.Add(new SqlParameter("@sParty_Cell", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Cell));
                //SCmd.Parameters.Add(new SqlParameter("@nParty_Credit_Bal", SqlDbType.Float, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Credit_Bal));
                //SCmd.Parameters.Add(new SqlParameter("@nParty_Credit_Days", SqlDbType.Float, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vParty_Credit_Days));
                ...
                SCmd.Parameters.Add(new SqlParameter("@nAmt_Item", SqlDbType.Float, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vAmt_Item));
                ...
                SCmd.Parameters.Add(new SqlParameter("@nQty_Item", SqlDbType.Float, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vQty_Item));
                ...
                //          SCmd.Parameters.Add(new SqlParameter("@nFY_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vFY_ID));
                SCmd.Parameters.Add(new SqlParameter("@nReturn", SqlDbType.BigInt, 9, ParameterDirection.ReturnValue, false, 18, 0, "", DataRowVersion.Proposed, 0));
                strRecAffected = clsDatabase1.Exec_Int_Multi("stpInv_Tr_CSR", SCmd, sqlcon, Tran);
                ...
                if (strRetValue == 1 && sErrorCode == "")
                {
                    ...
                    if (vlstDetail.Count > 0)
                    {
                        foreach (DataRow row in vlstDetail)
                        {
                            ...
                            SCmd.Parameters.Add(new SqlParameter("@nDept_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vDept_ID));
                            //           SCmd.Parameters.Add(new SqlParameter("@nDept_ID_Store", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vDept_ID_Store));
                            //SCmd.Parameters.Add(new SqlParameter("@nVrType", SqlDbType.Int, 9, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, 26));
                            if (vDept_ID_Store == -1)
                            {
                                SCmd.Parameters.Add(new SqlParameter("@nDept_ID_Store", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, DBNull.Value));
                            ...
                            SCmd.Parameters.Add(new SqlParameter("@nCatSub_ID", SqlDbType.Int, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, row["CatSub_ID"]));
                            ...
                            SCmd.Parameters.Add(new SqlParameter("@nR_Rate", SqlDbType.Float, 9, ParameterDirection.Input, false, 18, 3, "", DataRowVersion.Proposed, row["R_Rate"]));
                            ...
                            SCmd.Parameters.Add(new SqlParameter("@nR_Qty", SqlDbType.Float, 9, ParameterDirection.Input, false, 18, 3, "", DataRowVersion.Proposed, row["R_Qty"]));
                            SCmd.Parameters.Add(new SqlParameter("@nR_Qty_FOC", SqlDbType.Float, 9, ParameterDirection.Input, false, 18, 3, "", DataRowVersion.Proposed, row["R_Qty_FOC"]));
                            ...
                            if (strRetValue == 1)
                            {
                                ...
                                if (SCmd.Parameters["@dU_UD"].Value.ToString() != "")
                                    strU_UD = Convert.ToDateTime(SCmd.Parameters["@dU_UD"].Value).ToString("dd-MMM-yyyy hh:mm tt");
                                strPDate = Convert.ToDateTime(SCmd.Parameters["@dPDate"].Value).ToString("dd-MMM-yyyy hh:mm tt");
                            }
