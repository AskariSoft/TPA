...
namespace TPA.BLL.IN
{
    public class INSub_Category
    {
        ...
        public DataSet Fill_Combo(int vComp_ID, int vUser_ID)
        {
            ...
            ds_1 = clsDatabase1.Get_DS_SP("stpInv_SCategory", SCmd);
            sErrorCode = clsDatabase1.sErrorCode.Trim();
            return ds_1;
        }
        public DataSet Fill_ByCategory(int vComp_ID, int vUser_ID, int vCat_ID)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();
        ...
        public DataSet Find_Record(int vComp_ID, int vSCat_ID)
        {
            DataSet ds_1;
            SqlCommand SCmd = new SqlCommand();
            ...
            string vU_Name, int vU_S, string vAuth_D)
        {
            ...
            SCmd.Parameters.Add(new SqlParameter("@nSCat_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vID));
            ...
            strRowAffected = clsDatabase1.Exec_Int_SP("stpInv_SCategory", SCmd);
            sErrorCode = clsDatabase1.sErrorCode.Trim();
        ...
        public int Save_Master(string vID, string vCode, string vName, int vCat_ID, int vComp_ID,
            string vU_Name, int vU_S, int vIsUpdate, string vAuth_D
             )
        {
            ...
            if (vIsUpdate == 0)
            {
                SCmd.Parameters.Add(new SqlParameter("@nSCat_ID", SqlDbType.Int, 9, ParameterDirection.InputOutput, false, 18, 0, "", DataRowVersion.Proposed, DBNull.Value));

            }
            else
            {
                SCmd.Parameters.Add(new SqlParameter("@nSCat_ID", SqlDbType.Int, 9, ParameterDirection.InputOutput, false, 18, 0, "", DataRowVersion.Proposed, vID));

            }
            SCmd.Parameters.Add(new SqlParameter("@sSCat_D", SqlDbType.VarChar, 20, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Proposed, vCode));
            SCmd.Parameters.Add(new SqlParameter("@sSCat_DD", SqlDbType.VarChar, 255, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, vName));
            SCmd.Parameters.Add(new SqlParameter("@nCat_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, vCat_ID));
            ...
            strRecAffected = clsDatabase1.Exec_Int_SP("stpInv_SCategory", SCmd);
            sErrorCode = clsDatabase1.sErrorCode;
            strRetValue = Convert.ToInt32(SCmd.Parameters["@nReturn"].Value);
            vCat_ID = Convert.ToInt32(SCmd.Parameters["@nCat_ID"].Value);
            try
            {
                strErr_Msg = SCmd.Parameters["@sErr_Msg"].Value.ToString();
